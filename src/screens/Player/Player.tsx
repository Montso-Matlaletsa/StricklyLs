...
return (
    <View style={{ height: '100%', backgroundColor: '#102e4a' }}>
      ...
      <View
        style={{ height: 40, position: 'absolute', bottom: 0, width: '100%', flexDirection: 'row', marginBottom: 30 }}
      >
        <ControlButton icon={'repeat-sharp'} iconColor={ repeatSong  ? '#B87F3E' : 'white' } onPress={repeat} />

        <ControlButton icon={'play-skip-back-sharp'} onPress={() => TrackPlayer.skipToPrevious()} />

 
         {isLoading ? <ActivityIndicator /> :       <ControlButton
        ...
        <ControlButton icon={'play-skip-forward-sharp'} onPress={() => TrackPlayer.skipToNext()} />
